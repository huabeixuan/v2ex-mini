var HOST_URL = 'https://www.v2ex.com/api/'
...
// 获取用户主页 :username
var GET_MEMBER = '/api/members/show.json'
...
function _getAllNode(){
  return HOST_URL + ALL_NODE
}

function _getNodeInfo(o) {
  return HOST_URL + NODE_INFO + '?' + _obj2uri(o);
}
...
function _getHotestTopic(o) {
  return HOST_URL + HOT_TOPIC + '?' + _obj2uri(o);
}
